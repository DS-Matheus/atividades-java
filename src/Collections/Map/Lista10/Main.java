package Collections.Map.Lista10;
...
/*        Dadas as seguintes informações sobre meus livros favoritos e seus autores,
        ...
        exibindo (Nome Autor - Nome Collections.Map.Lista10.Lista10.Livro);
        Autor = Hawking, Stephen  - Collections.Map.Lista10.Lista10.Livro = nome: Uma Breve História do Tempo. páginas: 256
        Autor = Duhigg, Charles - Collections.Map.Lista10.Lista10.Livro = nome: O Poder do Hábito, paginas: 408
        Autor = Harari, Yuval Noah  - Collections.Map.Lista10.Lista10.Livro = 21 Lições Para o Século 21, páginas: 432*/
...
class Livro {
    ...
    public String toString() {
        return "Collections.Map.Lista10.Lista10.Livro{" +
                "titulo='" + titulo + '\'' +
