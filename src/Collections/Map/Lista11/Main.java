package Collections.Map.Lista11;
...
public class Main {
    public static void main(String[] args) {
        ...
        Collections.Map.Lista11.Estado = PE - população = 9.616.621
        Collections.Map.Lista11.Estado = AL - população = 3.351.543
        Collections.Map.Lista11.Estado = CE - população  = 9.187.103
        Collections.Map.Lista11.Estado = RN - população = 3.534.265
        */
...
class Estado{
    ...
    public String toString() {
        return "Collections.Map.Lista11.Estado{" +
                "uf='" + uf + '\'' +
                ", populacao=" + populacao +
                '}';
    }
